...
'''
@TOD implement get_token_auth_header() method
...
'''
@TOD implement check_permissions(permission, payload) method
    @INPUTS
...
'''
@TOD implement verify_decode_jwt(token) method
    @INPUTS
...
'''
@TOD implement @requires_auth(permission) decorator method
    @INPUTS
        permission: string permission (i.e. 'post:drink')
